...
//                ToastUtil.Toast("所选日期不能不能大于或等于当前日期");
    ...
    public static String exchangeStringDate(String date) throws ParseException {
        if (date != null ) {
            String result = date.substring(8, date.length());
            return result;
        }else{
            return null;
        }
     ...
     * @throws ParseException
     */
    public static String exchangeStringMonth(String date) throws ParseException {
        if (date != null ) {
     ...
     * @throws ParseException
     */
    public static String exchangeStringYear(String date) throws ParseException {
        if (date != null ) {
